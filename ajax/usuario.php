...
switch ($_GET["op"]) {
	...
	if (empty($idusuario)) {
		$rspta=$usuario->insertar($nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$idempresa,$login,$clavehash,$imagen,$_POST['permiso']);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar todos los datos del usuario";
	}else{
		$rspta=$usuario->editar($idusuario,$nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$idempresa,$login,$clavehash,$imagen,$_POST['permiso']);
	...
	while ($reg=$rspta->fetch_object()) {
		$rpts = $consulta->infoempresa($reg->idempresa);
