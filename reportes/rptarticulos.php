...
if (!isset($_SESSION['nombre'])) {
	...
	if ($_SESSION['almacen'] == 1) {
		...
		while ($reg = $rspta->fetch_object()) {
			...
			$pdf->Row(array(mb_convert_encoding($nombre, 'UTF-8', mb_detect_encoding($nombre)), mb_convert_encoding($categoria, 'UTF-8', mb_detect_encoding($categoria)), $codigo, $stock, mb_convert_encoding($descripcion, 'UTF-8', mb_detect_encoding($descripcion))));
		}
